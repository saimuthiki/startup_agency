---
name: configuring-kubernetes-ingress
description: |
  Kubernetes Ingress Config - Auto-activating skill for DevOps Advanced.
...
- Provides step-by-step guidance for kubernetes ingress config
...
- "Help me with kubernetes ingress config"
- "Set up kubernetes ingress config"
- "How do I implement kubernetes ingress config?"
